...
public class LoginController extends BaseController {
                         ...
                         @RequestParam(value = "verifyCode", required = true) String verifyCode)
    {
        ...
        {
            return result.failure(ResultConstant.LOGIN_FAILD_CODE_1001, ResultConstant.LOGIN_FAILD_MESSAGE_1001);
        }
        // 检查管理员账号状态
        else if(!admin.getStatus().equals(CommonConstant.STATUS_NORMAL))
        {
            return result.failure(ResultConstant.LOGIN_FAILD_CODE_1002, ResultConstant.LOGIN_FAILD_MESSAGE_1002);
        }
        ...
        {
            return result.failure(ResultConstant.LOGIN_FAILD_CODE_1003, ResultConstant.LOGIN_FAILD_MESSAGE_1003);
        }
        ...
        {
            return result.failure(ResultConstant.LOGIN_FAILD_CODE_1004, ResultConstant.LOGIN_FAILD_MESSAGE_1004);
        }
        ...
        {
            return result.failure(ResultConstant.LOGIN_FAILD_CODE_1005, ResultConstant.LOGIN_FAILD_MESSAGE_1005);
        }
        // 检查管理员角色状态
        ...
        // 更新管理员信息
        boolean isFaild = loginService.updateLogin(request, admin);
        if(isFaild)
        {
        ...
        return result.success(ResultConstant.LOGIN_SUCCESS_CODE, ResultConstant.LOGIN_SUCCESS_MESSAGE);
    }
}
